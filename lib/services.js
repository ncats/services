...
class Services {
    ...
    constructor(options = {}) {
        ...
        this._options = _.defaultsDeep( options, {
            logger,
            connections :  (_.get(global.LabShare, 'Config.services.options.connections')),
            loadServices:  (_.get(global.LabShare, 'Config.services.options.loadServices') || true),
            pattern :  (_.get(global.LabShare, 'Config.services.options.pattern') || '{src/api,api}/*.js'),
            main : (_.get(global.LabShare, 'Config.services.options.main')|| process.cwd()),
            directories : (_.get(global.LabShare, 'Config.services.options.directories')|| []),
            morgan : (_.get(global.LabShare, 'Config.services.options.morgan') || {
                enable: true,
            ...
            security : (_.get(global.LabShare, 'Config.services.options.security') || {
                sessionOptions: {
        ...
        this.server = serverUtils.createServer(this._app, this.logger);
