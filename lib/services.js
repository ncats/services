...
class Services {
    ...
    initialize() {
        function isProduction() {
            return this._app.get('env') === 'production';
        }

        this._initialized = true;

        let requestLoggingMode = isProduction() ? 'dev' : 'combined';
        ...
        if (isProduction()) {
            ...
            this._options.security.sessionOptions.cookie.secure = true;  // only allow SSL cookies
        }
