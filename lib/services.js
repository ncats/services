...
class Services {
     ...
     */
    constructor(options = {}) {
        let logger = _.get(global.LabShare, 'Logger', console);
        ...
        this._options = _.defaultsDeep(options, {
            logger,  // Default to the logger instance from the LSC LabShare package
            ...
            security: _.defaultsDeep(_.get(global.LabShare, 'Config.services.security', {}), {
                sessionOptions: {
        ...
        this._apiLoader = new Loader(this._app, this._options.loaderOptions);
        this._socketLoader = new SocketIOLoader(this._options.loaderOptions);
    }
