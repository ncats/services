 ...
 */
exports.exposeEndPoints = function exposeEndPoints(endPoints, directory) {
    ...
    let getendPointRoute = new Route(this.getPackageName(this.getPackageManifest(directory)), {
        path: "/endpoints",
        httpMethod: 'GET',
        middleware: [getReturnEndpoints]
    });

    let postendPointRoute = new Route(this.getPackageName(this.getPackageManifest(directory)), {
        path: "/endpoints",
        httpMethod: 'POST',
