 ...
 */
exports.exposeVersionRoute = function getVersionForPackage(packageDirectory) {
    let manifest = this.getPackageManifest(packageDirectory);
    ...
    function sanitizemanifest(manifest) {
        let manifestToReturn = manifest;
        return manifestToReturn;
    }

    return new Route(this.getPackageName(manifest), {
        path: "/version",
        httpMethod: 'GET',
